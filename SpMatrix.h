...
// 
// Эффективнее было бы для хранения ненулевых элементов использовать не два int-вектора, а один вектор содержащий 
// объекты хранящие в себе сразу и адрес элемента в матрице и его значение или же сделать свой аналог вектора,
// в котором бы ( в отличие от STL вектора) хранились сразу два поля данных, однако задание требовало использовать именно int-векторы
